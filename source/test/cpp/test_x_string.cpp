...
UNITTEST_SUITE_BEGIN(xstring)
{
	UNITTEST_FIXTURE(main)
	{
		...
		UNITTEST_TEST(FindOneOf)
		{
			...
			CHECK_EQUAL(-1,str1.findOneOf("abcdehijklmnopqrstuvwxyz1234567890",13));
		}
		...
		UNITTEST_TEST(substr)
		{
			xstring str = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
			CHECK_TRUE(str.substr(0,26) == "abcdefghijklmnopqrstuvwxyz");
			CHECK_TRUE(str == "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
		}
	}
}
UNITTEST_SUITE_END
