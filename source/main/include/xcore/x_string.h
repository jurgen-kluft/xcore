...
namespace xcore
{
	...
	public:
		...
		xstring				mid						(s32 inPosition, s32 inNum = -1) const;		///< Return a string containing <inNum> characters from this string, starting at <inPosition>
		...
		xstring				substr					(s32 inPosition= 0, s32 inNum = -1) const;
